...
function seleciona(x, y) {
  if (
    ...
    if (
      movimenta["selecionada"]["peca"] == "peao" &&
      movimenta["selecionada"]["cor"] == "branco" &&
      x == 1
    ) {
    ...
    if (
      movimenta["selecionada"]["peca"] == "peao" &&
      movimenta["selecionada"]["cor"] == "preto" &&
      x == 8
    ) {
    ...
    if (peca[x][y]["cor"] != movimenta["selecionada"]["cor"]) {
      ...
      document.getElementById(
        "t" + movimenta["selecionada"]["x"] + "" + movimenta["selecionada"]["y"]
      ).innerHTML = ""; //selcionada fica sem imagem
      document.getElementById("t" + x + "" + y).innerHTML =
        il[movimenta["selecionada"]["cor"]][movimenta["selecionada"]["peca"]]; //destino recebe a imagem da peça selecinada
      ...
      peca[movimenta["selecionada"]["x"]][movimenta["selecionada"]["y"]][
        "peca"
      ] = false; //peca selecionada recebe 0
      peca[movimenta["selecionada"]["x"]][movimenta["selecionada"]["y"]][
        "cor"
      ] = false; //cor selecionada recebe 0
